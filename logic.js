...
// Toggle project groups collapse/expand
document.querySelectorAll('.project-group-title').forEach(title => {
    title.addEventListener('click', () => {
        const group = title.closest('.project-group');
        if (group) {
